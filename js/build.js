...
const countryBoundaries = JSON.parse(fs.readFileSync('./assets/countryBoundaries.geojson', 'utf-8'));
...
fs.writeFileSync('./assets/countries.js', 'const countryBoundaries = ' + JSON.stringify(countryBoundaries), 'utf8');
